...
1. Update `MARKETING_VERSION` and `CURRENT_PROJECT_VERSION`, or pass them into the release scripts. Keep `CURRENT_PROJECT_VERSION` higher than any build number previously uploaded to App Store Connect.
2. Run tests:
